...
<div class="banner">
        <img src="<?php echo BASE_URL; ?>/images/banners/ms_turf_banner3.jpg" alt="Banner Image" class="img-fluid">
        <div class="overlay"></div>
        <div class="banner-text">
        <h1 class="mb-3 bread">Multisport Turf</h1>
		<p>Services >> Multisport Turf</p>
...
<section class="ftco-section ftco-no-pt ftco-no-pb mt-5">
	<div class="container">
		...
		<div class="col-md-6 d-flex">
					<img class="img-fluid d-flex align-items-center justify-content-center justify-content-md-end 70vh" src="<?php echo BASE_URL; ?>/images/service/ms2.jpg" alt="">
    		</div>
