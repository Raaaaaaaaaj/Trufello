...
<section class="ftco-section ftco-no-pt ftco-no-pb bg-light">
    	<div class="container">
			...
			<div class="col-md-6 d-flex">
					<img class="img-fluid d-flex align-items-center justify-content-center justify-content-md-end 70vh" src="<?php echo BASE_URL; ?>/images/service/proj_consul1.jpg" alt="">
    		</div>
